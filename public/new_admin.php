...
<?php
	...
	if(isset($_POST['submit'])){
        ...
        /*
            $admin_set = mysqli_query($connection, "CALL find_admin_by_username('$username')");
        ...
        */ 
            ...
            $username_exists = admin_username_exists($username);
            ...
            */    
                ...
                $query = "CALL insert_into_admin('$added_by', '$firstname', '$lastname', '$username', '$hashed_password', '$email', '$address', '$city' )";
...
<body>
    ...
    <div class="add_admin">
        ...
        <div class="container">
            ...
            <form class="form-horizontal" action="new_admin.php" method="post">
                ...
                <center>
                    <div class="form-group">        
                        <div class="col-sm-offset-5 col-sm-10">
                            ...
                            <a href="manage_admins.php" class="a"><input class="btn btn-default" type="button" onclick="return confirm('Are you sure you want to cancel?')" name="cancel" value="Cancel"/></a>   
                        </div>
                    </div>
                </center> 
                <br>
